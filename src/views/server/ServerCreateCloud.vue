        ...
        <el-form-item prop="cloud" label-width="0px" style="margin-left: 30%">
          <el-radio-group v-model="form.cloud">
            ...
            <el-radio label="tencent"
              ><img src="../../assets/img/tencent.png"
            /></el-radio>
          </el-radio-group>
        </el-form-item>
      </div>
  ...
  methods: {
    ...
    getCloudRegion() {
      if (this.form.cloud == "aliyun") {
        // 携带密钥请求
        this.$http
          .get("/cmdb/aliyun_cloud/", { params: this.form })
          .then((res) => {
            this.cloudRegion = res.data.data;
          });
      } else if (this.form.cloud == "tencent") {
        this.$http
          .get("/cmdb/tencent_cloud/", { params: this.form })
          .then((res) => {
            this.cloudRegion = res.data.data;
          });
      } else {
